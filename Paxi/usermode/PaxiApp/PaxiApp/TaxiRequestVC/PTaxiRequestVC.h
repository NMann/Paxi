...
@interface PTaxiRequestVC : UIViewController<UITextFieldDelegate,MKMapViewDelegate,PFavoriteAddressVCDelegate,NSURLConnectionDelegate ,UITableViewDataSource,UITableViewDelegate>
{
