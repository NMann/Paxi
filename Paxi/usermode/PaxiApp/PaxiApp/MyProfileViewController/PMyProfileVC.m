...
//    [self.navigationController pushViewController:myAccountVC animated:YES];
    ...
    {
       NSString *requestBody=[NSString stringWithFormat:@"&userid=%@&image=%@&mode=user&email=%@&phone=%@&name=%@",[[NSUserDefaults standardUserDefaults]valueForKey:userId],imageurl,self.emailTextField.text,self.mobileNumberTextField.text,self.nameTextField.text];
    ...
    {
        [SVProgressHUD showWithStatus:[dic valueForKey:@"data"]];
    }
    }];
    }
    else
